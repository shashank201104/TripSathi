    ...
    >
      ...
      >
        <motion.div
          ...
          exit={{ opacity: 0, y: 50 }}
          className="max-w-6xl mx-auto bg-surface border border-border rounded-2xl shadow-2xl overflow-hidden"
        >
          {/* Header */}
          <div className="relative h-64 md:h-80 bg-surface-elevated border-b border-border">
          ...
          <div className="p-3 md:p-8">
            ...
            <div className="grid grid-cols-3 gap-2 md:gap-6 mb-4 md:mb-8">
              <div className="bg-accent-muted border border-border p-2 md:p-6 rounded-xl">
                <div className="flex flex-col md:flex-row items-center gap-1 md:gap-3 mb-1 md:mb-2">
                  <div className="bg-accent p-1.5 md:p-3 rounded-lg">
                  ...
                  <div className="text-center md:text-left">
                    ...
                    <p className="text-sm md:text-2xl font-bold text-text-primary">
                      {itinerary.totalEstimatedCost?.currency}{" "}
              ...
              <div className="bg-success-muted border border-border p-2 md:p-6 rounded-xl">
                <div className="flex flex-col md:flex-row items-center gap-1 md:gap-3 mb-1 md:mb-2">
            ...
            {/* Daily Itinerary */}
            <div className="mb-8">
              <h3 className="text-lg md:text-2xl font-bold text-text-primary mb-3 md:mb-6">
                ...
                {itinerary.itinerary?.map((day, dayIndex) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-full bg-surface-elevated border border-border p-2 md:p-6 flex items-center justify-between hover:bg-accent-muted transition-all"
                    >
                      <div className="flex items-center gap-2 md:gap-4">
                        <div className="bg-accent text-white w-8 h-8 md:w-12 md:h-12 rounded-full flex items-center justify-center font-bold text-sm md:text-lg">
                          {day.day}
                        </div>
                        <div className="text-left">
                          <h4 className="text-xs md:text-lg font-bold text-text-primary">
                            Day {day.day}:{" "}
                            {day.title ||
                              day.theme ||
                      ...
                      <div className="flex items-center gap-2 md:gap-4">
                        <div className="text-right">
                          ...
                          <p className="text-xs md:text-base font-bold text-accent">
                      ...
                      {expandedDays.includes(dayIndex) && (
                        ...
                        >
                          <div className="p-2 md:p-6 space-y-3 md:space-y-6">
                            {/* Activities */}
                            <div>
                              <h5 className="font-semibold text-sm md:text-base text-text-primary mb-2 md:mb-4 flex items-center gap-2">
                                    ...
                                    >
                                      ...
                                      <div className="flex-1 min-w-0">
                                        <div className="flex items-start justify-between mb-0.5 md:mb-2">
                                          <p className="font-semibold text-xs md:text-base text-text-primary mr-2">
                                            {activity.activity}
                                          </p>
                              ...
                              <div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-4">
                                  {day.meals.map((meal, mealIdx) => (
                                      ...
                                      >
                                      <p className="font-semibold text-xs md:text-base text-text-primary mb-0.5 md:mb-1">
                                        {meal.type}
                                      </p>
